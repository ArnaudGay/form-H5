...
function Paragraph() {
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-center relative shrink-0 w-full" data-name="Paragraph">
      <p className="font-['Arial:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#323232] text-[24px] text-center w-[551px]">Cela nous sera d’une grande utilité pour envisager une solution pour cette période difficile.</p>
    </div>
  );
}
...
function QuestionScale() {
  return (
    <div className="relative shrink-0 w-[846px]" data-name="QuestionScale">
    ...
    <div className="bg-white relative rounded-[14px] size-full" data-name="Card">
      ...
      <div className="flex flex-col items-center size-full">
        <div className="box-border content-stretch flex flex-col gap-[24px] items-center px-[21px] py-[51px] relative size-full">
          <div className="h-[360px] relative shrink-0 w-[539px]" data-name="image 2">
            <img alt="" className="absolute bg-clip-padding border-0 border-[transparent] border-solid box-border inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage2} />
